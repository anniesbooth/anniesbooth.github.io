...
{\bf Ph.D.} Statistics, May 2023, advised by Robert B.~Gramacy \\
...
Renganathan, A. \& {\bf Booth, A. S.} (2026). Surrogate-guided adaptive importance sampling for failure probability estimation. arXiv:2603.20959
...
{\bf Booth, A. S.} (2025). Gradient-enhancement and gradient predictions for deep Gaussian process modeling of expensive computer experiments. arXiv:2512.18066
...
estimation for deterministic computer experiments. arXiv:2511.18111

Moran, K. R., Payne, R., Lawrence, E., Higdon, D., Walsh, S. A., {\bf Booth, A. S.}, 
Kwan, J., Day, A., 
...
Walsh, S. A., {\bf Booth, A. S.}, Higdon, D., Clark, J., Moran, K. R., \& Heitmann, K. (2026). 
Bayesian deep Gaussian processes for correlated functional data: A case study in cosmological 
matter power spectra. {\it Data Science in Science, just accepted.} arXiv:2507.18683

Wycoff, N., Smith, J. W., {\bf Booth, A. S.}, \& Gramacy, R. B. (2025). Voronoi 
candidates for Bayesian optimization. {\it Journal of Global Optimization, 94,} 
175-201. arXiv:2402.04922

{\bf Booth, A. S.} \& Renganathan, S. A. (2025). Two-stage design for failure 
probability estimation with Gaussian process surrogates. 
{\it Journal of Quality Technology, 57}(5), 500-516. arXiv:2410.04496

Cooper, A., {\bf Booth, A. S.}, \& Gramacy, R. B. (2025). Modernizing full 
posterior inference for surrogate modeling of categorical-output simulation 
experiments. {\it Quality Engineering, 38}(1), 91-110. arXiv:2501.14946

Barnett, S., Beesley, L. J., {\bf Booth, A. S.}, Gramacy, R. B., \& Osthus, D. 
(2025). Monotonic warpings for additive and deep Gaussian processes. 
{\it Statistics and Computing, 35}(3), 65. arXiv:2408.01540
...
Fernandez, J., Grunenwald, J., {\bf Booth, A. S.}, Kyger, C., Montanari, A., \& Braun, J. 
(2026). Optimization of an air-cooled diffuser downstream of a rotating detonation 
combustor. In {\it AIAA Scitech 2026 Forum} (p.2919).
...
National Science Foundation, Conference: {\it Fall Technical Conference} [PI]
Awarded for the 68th annual Fall Technical Conference held October 6-8, 2026
in Charlotte, NC, with Stephanie DeHart and Anne Driscoll. \hfill \$19,975

Virginia Tech Faculty Mentoring Grant, awarded in December 2025. \hfill \$1,500

Lawrence Livermore National Laboratory, Academic Collaboration Team: {\it Dimension reduction with 
...
National Science Foundation, Collaborative Research: MATH-DT: {\it Gradient-enhanced
...
\begin{tabular}{lrl}
IT\quad\quad & May 2026 & {\bf Spring Research Conference}, Clemson, SC \\
...
\begin{tabular}{lrl}
S\quad\quad & May 2026 & {\bf University of South Carolina}, virtual \\
...
{\sc STAT 6554 Advanced Statistical Computing, Virginia Tech}: Ph.D. level statistics graduate course covering
advanced programming concepts in R.  Bi-weekly 75-minute lectures; Spring 2026.

{\sc STAT 5014 Introduction to Statistical Programming Packages, Virginia Tech}: statistics graduate course introducing computing and statistical programming.  Weekly 50-minute lectures; Fall 2025.
...
\pagebreak
\section{}
\hfill {\bf Curriculum Vitae:} Annie S. Booth \  --- \  6
\medskip

\section{\bf SERVICE}

ASA/ASQ Fall Technical Conference Chair; 2026 \\
ASA Section on Physical and Engineering Sciences Council of Sections Representative; 2025-2026 \\
Two-time panelist for NSF Division of Mathematical Sciences; 2024 and 2025 \\
ASQ CPID Fall Technical Conference Program Representative; 2024 - 2025 \\
