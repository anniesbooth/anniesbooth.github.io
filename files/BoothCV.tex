...
Bayesian statistics, surrogate modeling, statistical computing, sequential design, 
uncertainty quantification, Monte Carlo inference, Markov chains.  
...
Finalist for the ISBA Savage Award; 2023 \\
...
Wycoff, N., Smith, J. W., Booth, A. S., \& Gramacy, R. B. (2024). Voronoi candidates for Bayesian optimization. arXiv:2402.04922

Booth, A. S., Renganathan, S. A., \& Gramacy, R. B. (2023). Contour location
for reliability in airfoil simulation experiments using deep Gaussian
processes.  arXiv:2308.04420

\medskip
\section{\bf{PEER- \\ REVIEWED \\ PAPERS}}

Sauer, A., Cooper, A., \& Gramacy, R. B. (2022). Vecchia-approximated
deep Gaussian processes for computer experiments. {\it Journal of Computational
and Graphical Statistics,} 1-14. arXiv:2204.02904
...
\pagebreak
\section{}
\hfill {\bf Curriculum Vitae:} Annie Sauer \  --- \  2
\medskip

Sauer, A., Gramacy, R. B., \& Higdon, D. (2021). Active learning 
for deep Gaussian process surrogates. {\it Technometrics, 65}(1), 4-18. 
arXiv:2012.08015

\section{OTHER \\ PUBLICATIONS}

Booth, A., Gramacy, R. B., \& Renganathan A. (2024). Actively learning deep Gaussian
process models for failure contour and reliability estimation.  In {\it AIAA Scitech 2024 Forum} (p.0577).

Sauer, A., Cooper, A., \& Gramacy, R. B. (2023). Non-stationary
Gaussian process surrogates. {\it chapter in Handbook of Uncertainty Quantification}, to appear; arXiv:2305.19242

Sauer, A. (2022). {\tt deepgp}: an {\sf R}-package for Bayesian deep Gaussian 
processes.  ISBA Bulletin, Software Highlight; December, 29(4).

Sauer, A. \& Gramacy R. B. (2022). Discussion of paper by Marmin \& Filippone.  An
...
Stanford, B., Sauer, A., Jacobson, K., \& Warner, J. (2022). 
...
\pagebreak
\section{}
\hfill {\bf Curriculum Vitae:} Annie Sauer \  --- \  3
...
CT& Jul 2021 & {\bf World Meeting of ISBA}, virtual \\
...
\pagebreak
\section{}
\hfill {\bf Curriculum Vitae:} Annie Sauer \  --- \  4
